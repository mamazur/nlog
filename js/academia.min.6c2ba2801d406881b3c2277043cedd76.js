...
!function(e, t) {
  ...
  s = {
      ...
      getTransitionDurationFromElement: function(e) {
          ...
          var n = t(e).css("transition-duration")
            ...
            , o = parseFloat(n)
            , i = parseFloat(s);
          return o || i ? (n = n.split(",")[0],
          s = s.split(",")[0],
          1e3 * (parseFloat(n) + parseFloat(s))) : 0
      },
      reflow: function(e) {
      ...
      typeCheckConfig: function(e, t, n) {
          for (o in n)
              if (Object.prototype.hasOwnProperty.call(n, o)) {
                  var o, c, a = n[o], i = t[o], r = i && s.isElement(i) ? "element" : (c = i,
    ...
    , C = function() {
      ...
      n._getRootElement = function(e) {
          var o = s.getSelectorFromElement(e)
            , n = !1;
          return o && (n = document.querySelector(o)),
      ...
      n._removeElement = function(e) {
          var n, o = this;
          t(e).removeClass(Xn),
          t(e).hasClass(Qn) ? (n = s.getTransitionDurationFromElement(e),
          t(e).one(s.TRANSITION_END, function(t) {
              return o._destroyElement(e, t)
          }).emulateTransitionEnd(n)) : this._destroyElement(e)
      }
      ,
  ...
  t(document).on(we.CLICK_DATA_API, '[data-dismiss="alert"]', C._handleDismiss(new C)),
  ...
  var te = "button"
    ...
    , N = function() {
      ...
      return n.toggle = function() {
          var e, o, s = !0, i = !0, n = t(this._element).closest(Wn)[0];
          if (n && (e = this._element.querySelector($n),
          e)) {
              if ("radio" === e.type && (e.checked && this._element.classList.contains(X) ? s = !1 : (o = n.querySelector(Hn),
              o && t(o).removeClass(X))),
              s) {
                  if (e.hasAttribute("disabled") || n.hasAttribute("disabled") || e.classList.contains("disabled") || n.classList.contains("disabled"))
                      return;
          ...
          i && this._element.setAttribute("aria-pressed", !this._element.classList.contains(X)),
  ...
  t(document).on(Je.CLICK_DATA_API, nt, function(e) {
      e.preventDefault();
      var n = e.target;
  ...
  ;
  var s, P, x = "carousel", ne = "bs.carousel", r = "." + ne, Ze = ".data-api", Pn = t.fn[x], ze = {
      interval: 5e3,
      keyboard: !0,
      slide: !1,
      pause: "hover",
      ...
      wrap: "boolean",
      touch: "boolean"
  }, oe = "next", me = "prev", Dn = "left", Tn = "right", c = {
      SLIDE: "slide" + r,
      SLID: "slid" + r,
      KEYDOWN: "keydown" + r,
  ...
  }, Mn = "carousel", v = "active", An = "slide", kn = "carousel-item-right", En = "carousel-item-left", Cn = "carousel-item-next", yn = "carousel-item-prev", bn = "pointer-event", vn = ".active", je = ".active.carousel-item", pn = ".carousel-item", at = ".carousel-item img", mn = ".carousel-item-next, .carousel-item-prev", un = ".carousel-indicators", ln = "[data-slide], [data-slide-to]", cn = '[data-ride="carousel"]', He = {
      TOUCH: "touch",
      PEN: "pen"
  }, E = function() {
      function n(e, t) {
      ...
      e.pause = function(e) {
          e || (this._isPaused = !0),
          this._element.querySelector(mn) && (s.triggerTransitionEnd(this._element),
          this.cycle(!0)),
      ...
      e.to = function(e) {
          var n, s, o = this;
          if (this._activeElement = this._element.querySelector(je),
      ...
      e._addTouchEventListeners = function() {
          ...
          this._touchSupported) {
              var e, n = function(t) {
                  ...
                  e._pointerEvent && He[t.originalEvent.pointerType.toUpperCase()] && (e.touchDeltaX = t.originalEvent.clientX - e.touchStartX),
                  e._handleSwipe(),
              ...
              t(this._element.querySelectorAll(at)).on(c.DRAG_START, function(e) {
              ...
              this._element.classList.add(bn)) : (t(this._element).on(c.TOUCHSTART, function(e) {
                  return n(e)
              }),
      ...
      e._getItemIndex = function(e) {
          return this._items = e && e.parentNode ? [].slice.call(e.parentNode.querySelectorAll(pn)) : [],
          this._items.indexOf(e)
      }
      ,
      e._getItemByDirection = function(e, t) {
          var s, o = e === oe, i = e === me, n = this._getItemIndex(t), a = this._items.length - 1;
          return (i && 0 === n || o && n === a) && !this._config.wrap ? t : (s = (n + (e === me ? -1 : 1)) % this._items.length,
      ...
      e._setActiveIndicatorElement = function(e) {
          if (this._indicatorsElement) {
              var n, s = [].slice.call(this._indicatorsElement.querySelectorAll(vn));
              t(s).removeClass(v),
      ...
      e._slide = function(e, n) {
          var a, r, l, d, f, h = this, i = this._element.querySelector(je), p = this._getItemIndex(i), o = n || i && this._getItemByDirection(e, i), g = this._getItemIndex(o), m = Boolean(this._interval), u = e === oe ? (a = En,
          r = Cn,
          Dn) : (a = kn,
          r = yn,
          Tn);
          o && t(o).hasClass(v) ? this._isSliding = !1 : !this._triggerSlideEvent(o, u).isDefaultPrevented() && i && o && (this._isSliding = !0,
          m && this.pause(),
          ...
          t(this._element).hasClass(An) ? (t(o).addClass(r),
          s.reflow(o),
          t(i).addClass(a),
          t(o).addClass(a),
          d = parseInt(o.getAttribute("data-interval"), 10),
          ...
          t(i).one(s.TRANSITION_END, function() {
              t(o).removeClass(a + " " + r).addClass(v),
              t(i).removeClass(v + " " + r + " " + a),
              h._isSliding = !1,
              setTimeout(function() {
                  return t(h._element).trigger(l)
              }, 0)
          }).emulateTransitionEnd(f)) : (t(i).removeClass(v),
          t(o).addClass(v),
          this._isSliding = !1,
      ...
      n._jQueryInterface = function(e) {
          return this.each(function() {
              var a, s = t(this).data(ne), o = i({}, ze, t(this).data());
              if ("object" == typeof e && (o = i({}, o, e)),
      ...
      n._dataApiClickHandler = function(e) {
          ...
          a && (o = t(a)[0],
          o && t(o).hasClass(Mn))) {
              var o, a, c = i({}, t(o).data(), t(this).data()), r = this.getAttribute("data-slide-to");
              r && (c.interval = !1),
  ...
  t(window).on(c.LOAD_DATA_API, function() {
      for (var n, s = [].slice.call(document.querySelectorAll(cn)), e = 0, o = s.length; e < o; e++)
          n = t(s[e]),
  ...
  var A = "collapse"
    ...
    , V = function() {
      function n(e, t) {
          ...
          for (var i = [].slice.call(document.querySelectorAll(Ne)), n = 0, r = i.length; n < r; n++) {
              var a = i[n]
                , o = s.getSelectorFromElement(a)
                , c = [].slice.call(document.querySelectorAll(o)).filter(function(t) {
                  return t === e
              });
              null !== o && 0 < c.length && (this._selector = o,
      ...
      e.show = function() {
          if (o = this,
          !this._isTransitioning && !t(this._element).hasClass(y) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(Yt)).filter(function(e) {
              return "string" == typeof o._config.parent ? e.getAttribute("data-parent") === o._config.parent : e.classList.contains(Y)
          })).length && (e = null),
          !(e && (a = t(e).not(this._selector).data(b)) && a._isTransitioning)) && (r = t.Event(J.SHOW),
          ...
          !r.isDefaultPrevented())) {
              ...
              this._triggerArray.length && t(this._triggerArray).removeClass(ye).attr("aria-expanded", !0),
      ...
      e.hide = function() {
          if (o = this,
          !this._isTransitioning && t(this._element).hasClass(y) && (i = t.Event(J.HIDE),
          ...
          !i.isDefaultPrevented())) {
              ...
              0 < a)
                  for (n = 0; n < a; n++) {
                      var e, n, o, i, a, l, r = this._triggerArray[n], c = s.getSelectorFromElement(r);
                      null !== c && (t([].slice.call(document.querySelectorAll(c))).hasClass(y) || t(r).addClass(ye).attr("aria-expanded", !1))
                  }
              this.setTransitioning(!0),
      ...
      ,
      e._getConfig = function(e) {
          return (e = i({}, Ee, e)).toggle = Boolean(e.toggle),
      ...
      n._jQueryInterface = function(e) {
          return this.each(function() {
              ...
              if (!s && a.toggle && /show|hide/.test(e) && (a.toggle = !1),
              s || (s = new n(this,a),
              o.data(b, s)),
              "string" == typeof e) {
    ...
    , p = function() {
      ...
      return o.toggle = function() {
          if (!this._element.disabled && !t(this._element).hasClass(ae)) {
              var i, r, c, o = e._getParentFromElement(this._element), d = t(this._menu).hasClass(l);
              if (e._clearMenus(),
              !d && (r = {
              ...
              !c.isDefaultPrevented())) {
                  if (!this._inNavbar) {
                      ...
                      this._popper = new n(i,this._menu,this._getPopperConfig())
                  }
                  "ontouchstart"in document.documentElement && 0 === t(o).closest(Nt).length && t(document.body).children().on("mouseover", null, t.noop),
                  this._element.focus(),
      ...
      ,
      o.show = function() {
          if (!(this._element.disabled || t(this._element).hasClass(ae) || t(this._menu).hasClass(l))) {
              var n = {
                  relatedTarget: this._element
              }
                , s = t.Event(a.SHOW, n)
              ...
              t(o).trigger(s),
              s.isDefaultPrevented() || (t(this._menu).toggleClass(l),
      ...
      o._getConfig = function(e) {
          return e = i({}, this.constructor.Default, t(this._element).data(), e),
      ...
      o._getPlacement = function() {
          var n = t(this._element.parentNode)
            , e = Ct;
          return n.hasClass(Ut) ? (e = At,
          t(this._menu).hasClass(Re) && (e = Et)) : n.hasClass(Vt) ? e = Ot : n.hasClass(Bt) ? e = bt : t(this._menu).hasClass(Re) && (e = xt),
          e
      }
      ,
      ...
      o._getOffset = function() {
          ...
          return "function" == typeof this._config.offset ? e.fn = function(e) {
              return e.offsets = i({}, e.offsets, t._config.offset(e.offsets, t._element) || {}),
              e
          }
      ...
      e._jQueryInterface = function(n) {
          return this.each(function() {
              var s = t(this).data(B);
              if (s || (s = new e(this,"object" == typeof n ? n : null),
              t(this).data(B, s)),
              "string" == typeof n) {
      ...
      e._clearMenus = function(n) {
          if (!n || 3 !== n.which && ("keyup" !== n.type || 9 === n.which))
              for (var c, u, o = [].slice.call(document.querySelectorAll(re)), s = 0, h = o.length; s < h; s++) {
                  ...
                  d && (u = d._menu,
                  t(i).hasClass(l) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "keyup" === n.type && 9 === n.which) && t.contains(i, n.target)) && (c = t.Event(a.HIDE, r),
                  t(i).trigger(c),
      ...
      e._dataApiKeydownHandler = function(n) {
          if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || t(n.target).closest(Te).length)) : Kt.test(n.which)) && (n.preventDefault(),
          n.stopPropagation(),
          !this.disabled && !t(this).hasClass(ae))) {
              var s, o, r, i = e._getParentFromElement(this), a = t(i).hasClass(l);
              a && (!a || 27 !== n.which && 32 !== n.which) ? (o = [].slice.call(i.querySelectorAll(Dt)),
              0 !== o.length && (s = o.indexOf(n.target),
              38 === n.which && 0 < s && s--,
              40 === n.which && s < o.length - 1 && s++,
              s < 0 && (s = 0),
              o[s].focus())) : (27 === n.which && (r = i.querySelector(re),
              t(r).trigger("focus")),
  ...
  t(document).on(a.KEYDOWN_DATA_API, re, p._dataApiKeydownHandler).on(a.KEYDOWN_DATA_API, Te, p._dataApiKeydownHandler).on(a.CLICK_DATA_API + " " + a.KEYUP_DATA_API, p._clearMenus).on(a.CLICK_DATA_API, re, function(e) {
      e.preventDefault(),
      e.stopPropagation(),
  ...
  var F = "modal"
    ...
    , R = function() {
      ...
      e.show = function(e) {
          var s, n = this;
          !this._isShown && !this._isTransitioning && (t(this._element).hasClass(S) && (this._isTransitioning = !0),
          s = t.Event(o.SHOW, {
              relatedTarget: e
          }),
      ...
      e.hide = function(e) {
          var n, i, a, r = this;
          e && e.preventDefault(),
          this._isShown && !this._isTransitioning && (n = t.Event(o.HIDE),
          ...
          i ? (a = s.getTransitionDurationFromElement(this._element),
      ...
      e._getConfig = function(e) {
          return e = i({}, ke, e),
          s.typeCheckConfig(F, e, dt),
          e
      }
      ,
      e._showElement = function(e) {
          var i, r, c, n = this, a = t(this._element).hasClass(S);
          this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element),
          this._element.style.display = "block",
          this._element.removeAttribute("aria-hidden"),
          this._element.setAttribute("aria-modal", !0),
          t(this._dialog).hasClass(lt) ? this._dialog.querySelector(mt).scrollTop = 0 : this._element.scrollTop = 0,
          ...
          ,
          a ? (c = s.getTransitionDurationFromElement(this._dialog),
          t(this._dialog).one(s.TRANSITION_END, i).emulateTransitionEnd(c)) : i()
      }
      ,
      ...
      e._showBackdrop = function(e) {
          var a, r, c, n = this, i = t(this._element).hasClass(S) ? S : "";
          if (this._isShown && this._config.backdrop) {
              ...
              !this._isShown && this._backdrop ? (t(this._backdrop).removeClass(ge),
              a = function() {
                  n._removeBackdrop(),
                  e && e()
              }
              ,
              t(this._element).hasClass(S) ? (c = s.getTransitionDurationFromElement(this._backdrop),
              t(this._backdrop).one(s.TRANSITION_END, a).emulateTransitionEnd(c)) : a()) : e && e()
      }
      ,
      ...
      e._setScrollbar = function() {
          ...
          this._isBodyOverflowing) {
              var e, n, s, o = [].slice.call(document.querySelectorAll(Qe)), i = [].slice.call(document.querySelectorAll(Xe));
              t(o).each(function(n, s) {
                  var o = s.style.paddingRight
                    , i = t(s).css("padding-right");
                  t(s).data("padding-right", o).css("padding-right", parseFloat(i) + e._scrollbarWidth + "px")
              }),
              t(i).each(function(n, s) {
                  var o = s.style.marginRight
                    , i = t(s).css("margin-right");
                  t(s).data("margin-right", o).css("margin-right", parseFloat(i) - e._scrollbarWidth + "px")
              }),
              n = document.body.style.paddingRight,
              s = t(document.body).css("padding-right"),
              t(document.body).data("padding-right", n).css("padding-right", parseFloat(s) + this._scrollbarWidth + "px")
          }
          t(document.body).addClass(et)
      }
      ,
      e._resetScrollbar = function() {
          var e, n, s = [].slice.call(document.querySelectorAll(Qe));
          ...
          t(e).each(function(e, n) {
              ...
              "undefined" != typeof s && t(n).css("margin-right", s).removeData("margin-right")
          }),
  ...
  t(document).on(o.CLICK_DATA_API, ft, function(e) {
      var n, c, l, a = this, r = s.getSelectorFromElement(this);
      ...
      for (var o = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(t), i = [].slice.call(o.body.querySelectorAll("*")), r = function(e) {
          ...
          o.forEach(function(e) {
              (function(e, t) {
                  ...
                  -1 !== t.indexOf(n))
                      return -1 === jt.indexOf(n) || Boolean(e.nodeValue.match(_t) || e.nodeValue.match(wt));
  ...
  var j = "tooltip"
    ...
    , g = function() {
      ...
      e.show = function() {
          if (e = this,
          "none" === t(this.element).css("display"))
              throw new Error("Please use show on visible elements");
          if (i = t.Event(this.constructor.Event.SHOW),
          this.isWithContent() && this._isEnabled) {
              t(this.element).trigger(i);
              var e, o, i, a, r, c, d, u, h, l = s.findShadowRoot(this.element), m = t.contains(null !== l ? l : this.element.ownerDocument.documentElement, this.element);
              if (i.isDefaultPrevented() || !m)
                  return;
              ...
              d = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
              ...
              ,
              t(this.tip).hasClass(D) ? (h = s.getTransitionDurationFromElement(this.tip),
              t(this.tip).one(s.TRANSITION_END, c).emulateTransitionEnd(h)) : c()
          }
      }
      ,
      e.hide = function(e) {
          var r, n = this, o = this.getTipElement(), i = t.Event(this.constructor.Event.HIDE), a = function() {
              n._hoverState !== Q && o.parentNode && o.parentNode.removeChild(o),
              n._cleanTipClass(),
          ...
          t(this.element).trigger(i),
          !i.isDefaultPrevented() && (t(o).removeClass(K),
          ...
          t(this.tip).hasClass(D) ? (r = s.getTransitionDurationFromElement(o),
          t(o).one(s.TRANSITION_END, a).emulateTransitionEnd(r)) : a(),
          this._hoverState = "")
      }
      ,
      e.update = function() {
      ...
      e.setElementContent = function(e, n) {
          "object" != typeof n || !n.nodeType && !n.jquery ? this.config.html ? (this.config.sanitize && (n = Ye(n, this.config.whiteList, this.config.sanitizeFn)),
      ...
      e._getOffset = function() {
          ...
          return "function" == typeof this.config.offset ? e.fn = function(e) {
              return e.offsets = i({}, e.offsets, t.config.offset(e.offsets, t.element) || {}),
              e
          }
      ...
      e._setListeners = function() {
          ...
          this.config.trigger.split(" ").forEach(function(n) {
              if ("click" === n)
                  ...
                  var s = n === W ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN
                    , o = n === W ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                  t(e.element).on(s, e.config.selector, function(t) {
                      return e._enter(t)
      ...
      e._enter = function(e, n) {
          var s = this.constructor.DATA_KEY;
          (n = n || t(e.currentTarget).data(s)) || (n = new this.constructor(e.currentTarget,this._getDelegateConfig()),
          t(e.currentTarget).data(s, n)),
          e && (n._activeTrigger["focusin" === e.type ? Oe : W] = !0),
          t(n.getTipElement()).hasClass(K) || n._hoverState === Q ? n._hoverState = Q : (clearTimeout(n._timeout),
          n._hoverState = Q,
      ...
      e._fixTransition = function() {
          ...
          null === e.getAttribute("x-placement") && (t(e).removeClass(D),
      ...
      o._jQueryInterface = function(e) {
          return this.each(function() {
              var n = t(this).data(pe)
                , s = "object" == typeof e && e;
              if ((n || !/dispose|hide/.test(e)) && (n || (n = new o(this,s),
              t(this).data(pe, n)),
              "string" == typeof e)) {
    ...
    , fe = function(e) {
      ...
      n._jQueryInterface = function(e) {
          return this.each(function() {
              ...
              if ((s || !/dispose|hide/.test(e)) && (s || (s = new n(this,o),
              t(this).data(ue, s)),
              "string" == typeof e)) {
                  if ("undefined" == typeof s[e])
                      throw new TypeError('No method named "' + e + '"');
  ...
  var w = "scrollspy"
    ...
    , G = function() {
      function n(e, n) {
          ...
          this._selector = this._config.target + " " + _e + "," + this._config.target + " " + $e + "," + this._config.target + " " + wn,
          this._offsets = [],
          this._targets = [],
      ...
      return e.refresh = function() {
          ...
          [].slice.call(document.querySelectorAll(this._selector)).map(function(e) {
              ...
              r.width || r.height) ? [t(o)[n]().top + i, a] : null
          }).filter(function(e) {
              return e
          }).sort(function(e, t) {
              return e[0] - t[0]
      ...
      ,
      e._getConfig = function(e) {
          if ("string" != typeof (e = i({}, Ie, "object" == typeof e && e ? e : {})).target) {
              var n = t(e.target).attr("id");
              n || (n = s.getUID(w),
              t(e.target).attr("id", n)),
              e.target = "#" + n
          }
          return s.typeCheckConfig(w, e, hn),
          e
      }
      ,
      ...
      e._activate = function(e) {
          ...
          n.hasClass(fn) ? (n.closest(_n).find(On).addClass(_),
          n.addClass(_)) : (n.addClass(_),
          n.parents(Ve).prev(_e + ", " + $e).addClass(_),
          n.parents(Ve).prev(jn).children(_e).addClass(_)),
          t(this._scrollElement).trigger(Se.ACTIVATE, {
              relatedTarget: e
          })
      }
      ,
      ...
      n._jQueryInterface = function(e) {
          return this.each(function() {
              ...
              if (s || (s = new n(this,"object" == typeof e && e),
              t(this).data(se, s)),
              "string" == typeof e) {
                  if ("undefined" == typeof s[e])
                      throw new TypeError('No method named "' + e + '"');
  ...
  t(window).on(Se.LOAD_DATA_API, function() {
      for (var e, n = [].slice.call(document.querySelectorAll(gn)), s = n.length; s--; )
          e = t(n[s]),
  ...
  var ve = "bs.tab"
    ...
    , H = function() {
      ...
      return n.show = function() {
          if (i = this,
          !(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass($) || t(this._element).hasClass(zn))) {
              var e, o, i, a, r, c, d, n = t(this._element).closest(Rn)[0], l = s.getSelectorFromElement(this._element);
              n && (d = "UL" === n.nodeName || "OL" === n.nodeName ? tt : Ge,
      ...
      n._activate = function(e, n, o) {
          var r, c = this, i = (!n || "UL" !== n.nodeName && "OL" !== n.nodeName ? t(n).children(Ge) : t(n).find(tt))[0], l = o && i && t(i).hasClass(Ke), a = function() {
              return c._transitionComplete(e, i, o)
          };
          i && l ? (r = s.getTransitionDurationFromElement(i),
          t(i).removeClass(qe).one(s.TRANSITION_END, a).emulateTransitionEnd(r)) : a()
      }
      ,
      n._transitionComplete = function(e, n, o) {
          if (n) {
              t(n).removeClass($);
              var i, r, a = t(n.parentNode).find(Vn)[0];
              a && t(a).removeClass($),
          ...
          e.parentNode && t(e.parentNode).hasClass(Fn)) && (i = t(e).closest(Ln)[0],
          i && (r = [].slice.call(i.querySelectorAll(Bn)),
          t(r).addClass($)),
  ...
  t(document).on(U.CLICK_DATA_API, In, function(e) {
      e.preventDefault(),
      H._jQueryInterface.call(t(this), "show")
  }),
  ...
  var k = "toast"
    ...
    , ce = function() {
      ...
      return e.show = function() {
          ...
          t(this._element).one(s.TRANSITION_END, n).emulateTransitionEnd(o)) : n()
      }
      ,
      e.hide = function(e) {
          var n = this;
          this._element.classList.contains(Z) && (t(this._element).trigger(O.HIDE),
      ...
      e.dispose = function() {
          clearTimeout(this._timeout),
          this._timeout = null,
          this._element.classList.contains(Z) && this._element.classList.remove(Z),
          t(this._element).off(O.CLICK_DISMISS),
      ...
      ,
      e._getConfig = function(e) {
          return e = i({}, it, t(this._element).data(), "object" == typeof e && e ? e : {}),
...
function(e) {
  let m = e(".navbar")
    , t = m.innerHeight();
  function a(n) {
      n = typeof n == "undefined" || typeof n == "object" ? window.location.hash : n,
      n = n.replace(/:/g, "\\:"),
      e(n).length && (e("body").addClass("scrolling"),
      e("html, body").animate({
          scrollTop: e(n).offset().top - t
      }, 600, function() {
  ...
  function v() {
      ...
      s && (s._config.offset = t,
      n.data("bs.scrollspy", s),
      n.scrollspy("refresh"))
  }
  function d() {
      if (window.history.pushState) {
          let e = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.hash;
  ...
  jQuery.extend(jQuery.easing, {
      easeInOutExpo: function(e, t, n, s, o) {
          return t === 0 ? n : t === o ? n + s : (t /= o / 2) < 1 ? s / 2 * Math.pow(2, 10 * (t - 1)) + n : s / 2 * (-Math.pow(2, -10 * --t) + 2) + n
      }
  }),
  e(document).on("click", ".navbar-collapse.show", function(t) {
      let n = e(t.target).is("a") ? e(t.target) : e(t.target).parent();
      n.is("a") && n.attr("class") != "dropdown-toggle" && e(this).collapse("hide")
  });
  let o = {}, i, s, n = e("#container-publications");
  n.isotope({
  ...
  e(".pub-filters").on("change", function() {
      let i = e(this)
        , t = i[0].getAttribute("data-filter-group");
      if (o[t] = this.value,
      s = c(o),
      n.isotope(),
      t == "pubtype") {
          let t = e(this).val();
          t.substr(0, 9) == ".pubtype-" ? window.location.hash = t.substr(9) : window.location.hash = ""
      }
  });
  function f() {
      let t = window.location.hash.replace("#", "")
        , i = "*";
      t != "" && !isNaN(t) && (i = ".pubtype-" + t);
      let a = "pubtype";
      o[a] = i,
      s = c(o),
      n.isotope(),
  ...
  function r() {
      e("body").hasClass("searching") ? (e("[id=search-query]").blur(),
      e("body").removeClass("searching"),
      d()) : (e("body").addClass("searching"),
      e(".search-results").css({
          opacity: 0,
          visibility: "visible"
      }).animate({
          opacity: 1
  ...
  function j() {
      e(".carousel").each(function() {
          let t = e(".carousel-item", this);
          t.css("min-height", 0);
          let n = Math.max.apply(null, t.map(function() {
  ...
  e(window).on("load", function() {
      window.location.hash && (window.location.hash == "#top" ? window.location.hash = "" : e(".projects-container").length || a());
      let o = e("body");
      o.scrollspy({
          offset: t
      });
      ...
      e(".projects-container").each(function(t, n) {
          let s = e(n), o = s.closest("section"), i;
          o.find(".isotope").hasClass("js-layout-row") ? i = "fitRows" : i = "masonry",
          s.imagesLoaded(function() {
              ...
              o.find(".project-filters a").click(function() {
                  let t = e(this).attr("data-filter");
                  return s.isotope({
                      filter: t
                  }),
                  e(this).removeClass("active").addClass("active").siblings().removeClass("active all"),
                  !1
              }),
              window.location.hash && a()
          })
      }),
      e(".pub-filters-select") && f(),
      e(".js-cite-modal").click(function(t) {
          t.preventDefault();
          let n = e(this).attr("data-filename")
            , s = e("#modal");
          s.find(".modal-body code").load(n, function(t, s, o) {
              if (s == "error") {
                  let t = "Error: ";
                  e("#modal-error").html(t + o.status + " " + o.statusText)
              } else
                  e(".js-download-cite").attr("href", n)
          }),
          s.modal("show")
      }),
      ...
      e(document).on("keydown", function(t) {
          t.which == 27 ? e("body").hasClass("searching") && r() : t.which == 191 && t.shiftKey == !1 && !e("input,textarea").is(":focus") && (t.preventDefault(),
          r())
      })
  }),
  e(window).on("load resize orientationchange", j)
}(jQuery)
